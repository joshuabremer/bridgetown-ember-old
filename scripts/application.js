...
App.FixtureAdapter = DS.FixtureAdapter.extend({
    ...
    Name: "Lance Bangs",
    Bio: "<p>Bio to come.</p>\n",
    PhotoUrl: "http://bridgetown.festivalthing.com/sites/default/files/images/performers/lancebangs.jpg",
    PerformerId: "7882",
    SortOrder: 100,
    id: "7882",
    ...
    events: [ "7645", "7750", "7796", "7914", "7918" ]
}, {
    Name: "W. Kamau Bell",
    ...
    events: [ "7624", "7651", "7710", "7734", "7810" ]
}, {
    ...
    events: [ "7633", "7645", "7646", "7648", "7667", "7807", "7918" ]
}, {
    ...
    events: [ "7624", "7632", "7671", "7699", "7808" ]
}, {
    Name: "Leo Flowers",
    ...
    events: [ "7624", "7646", "7697", "7739", "7744" ]
}, {
    Name: "David Zoe Leon",
...
App.PerformerController = Ember.ObjectController.extend({}), App.PerformersController = Ember.ArrayController.extend({
    ...
    function program1(depth0, data) {
        var stack1, helper, options, buffer = "";
        return data.buffer.push("\n          <li><strong>"), stack1 = helpers._triageMustache.call(depth0, "event.Name", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            contexts: [ depth0 ],
